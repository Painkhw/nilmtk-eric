...
from keras.layers import Conv1D, Dense, Dropout, Reshape, Flatten, PReLU, LeakyReLU, ELU
...
class Seq2SeqELU(Disaggregator):

    def __init__(self, params):

        self.MODEL_NAME = "Seq2SeqELU"
    ...
    def partial_fit(self,train_main,train_appliances,do_preprocessing=True,**load_kwargs):
        ...
        print("...............Seq2SeqPReLU partial_fit running...............")
    ...
    def return_network(self):
        ...
        model = Sequential()
        # 1D Conv
        model.add(Conv1D(30,10,input_shape=(self.sequence_length,1),strides=2))
        model.add(PReLU(alpha_initializer='zeros', alpha_regularizer=None, alpha_constraint=None, shared_axes=None))
        model.add(Conv1D(30, 8, strides=2))
        model.add(PReLU(alpha_initializer='zeros', alpha_regularizer=None, alpha_constraint=None, shared_axes=None))
        model.add(Conv1D(40, 6, strides=1))
        model.add(PReLU(alpha_initializer='zeros', alpha_regularizer=None, alpha_constraint=None, shared_axes=None))
        model.add(Conv1D(50, 5, strides=1))
        model.add(PReLU(alpha_initializer='zeros', alpha_regularizer=None, alpha_constraint=None, shared_axes=None))
        model.add(Dropout(.2))
        model.add(Conv1D(50, 5, strides=1))
        model.add(PReLU(alpha_initializer='zeros', alpha_regularizer=None, alpha_constraint=None, shared_axes=None))
